...
breakfast = ['breakfast', 'Breakfast', 'second', 'Second'] #Nothing in LOTR was worse than the war of Aragorn vs Second Breakfast
      ...
      for keyword in aragorn: #look first for Aragorn if found then look for the any of the following otherwise proceed to last phase, just Aragorn
        if keyword in comment.body and comment.id not in comment_replied_to and not comment.author == r.user.me:
            ...
            for keyword in gondor_aragorn:
                if keyword in comment.body and comment.id not in comment_replied_to and not comment.author == r.user.me:
                    ...
                    gondor= ['Stand your ground, sons of Gondor of Rohan my brothers. I see in your eyes the same fear that would take the heart of me! A day may come when the courage of men fails when we forsake our friends and break all bonds of fellowship but it is not this day! An hour of wolves and shattered shields when the age of men comes crashing down but it is not this day, this day we fight!!! And for all that is dear to you in this world I bid you stand men of the west and fight! ',
                             'Be at peace son of Gondor.' , 'THE BEACONS OF MINAS TIRITH! THE BEACONS ARE LIT! GONDOR CALLS FOR AID!' , 'You shall not enter the realm of Gondor.' , 'I will not let the White city fall nor our people fail', 'There is no strength in Gondor that can avail us'] #these are the quotes that it will say when Gondor is found
            ...
            for keyword in Gate:
                if keyword in comment.body and comment.id not in comment_replied_to and not comment.author == r.user.me:
                    print("I came")
                    comment.reply("Hold your ground, hold your ground. Sons of Gondor, of Rohan my brothers. I see in your eyes the same fear that would take the heart of me. A day may come when the courage of men fails when we forsake our friends and break all bonds of fellowship but it is not this day. An hour of woes and shattered shields when the age of men comes crashing down but it is not this day. This day we fight! By all that you hold dear on this good earth I bid you stand, men of the west!")
                    comment_replied_to.append(comment.id)
            ...
            for keyword in hope:
                if keyword in comment.body and comment.id not in comment_replied_to and not comment.author == r.user.me:
                    print("Ring")
                    comment.reply("No. There is still hope for Frodo. He needs time... And safe passage across the plains of Gorgoroth. We can give him that.'")
                    comment_replied_to.append(comment.id)
        ...
        for keyword in aragorn:
            if keyword in comment.body and comment.id not in comment_replied_to and not comment.author == r.user.me:
                ...
                list = ['I would have gone with you to the end into the very fires of Mordor.',
                        ...
                        'I swore to protect you.', 'If by my life or death I can protect you, I will. You have my sword.', 'You have my sword'
                       ...
                       ' Indeed. I can avoid being seen if I wish, but to disappear entirely, that is a rare gift.',  'There is no strength in Gondor that can avail us', 'I will not lead the Ring within a hundred leagues of your city!', comment.author.name +  "," + "  "'the Argonath! Long have I desired to look upon the kings of old... My kin', ' That is our road. I suggest you take some rest and recover your strength, Master Dwarf', 'No. Orcs patrol the eastern shore. We must wait for cover of darkness.', 'We cross the lake at nightfall. Hide the boats and continue on foot. We approach Mordor from the north.', 'Gentlemen, we do not stop til nightfal', 'You said you"d bind yourself to me. Forsaking the immortal life of your people.',
                        'Come on, come on! Take cover!', 'Boromir! Give the Ring to Frodo.', ' The mines are no place for a pony, even one so brave as Bill.', 'Get back! Stay close to Gandalf!', 'Haldir o Lórien. Henion aníron, boe ammen i dulu lîn. Boe ammen veriad lîn.', ' Frodo’s fate is no longer in our hands.', 'Not idly do the leaves of Lorien fall',
                        'Rohan, home of the horse-lords','There"s something strange at work here. Some evil gives speed to these creatures, sets it"s will against us', 'Legolas! What do your elf-eyes see?', 'Riders of Rohan! What news from the Mark?', 'I"m Aragorn, son of Arathorn. This is Gimli, son of Gloin, and Legolas, from the Woodland realm. We are friends of Rohan and of Theoden, your king.', 'We are no spies. We track a band of Uruk-hai westward across the plains. They have taken two of our friends captive.', 'They will be small, only children to your eyes', 'Tracks lead away from the battle, into...Fangorn Forest.', 'Do not let him speak. He will put a spell on us!', 'You fell!', 'No my lord! No my lord. Let him go. Enough blood has been spilt on his account.',
                        'You have 2000 good men riding north as we speak. Éomer is loyal to you. His men will return and fight for their king.' , 'He’s only doing what he thinks is best for his people. Helm’s Deep has saved them in the past.',  'What do you fear my lady?', 'King Théoden has a good memory. He was only a small child at the time.', 'She stays because she still has hope.', 'She is sailing to the Undying Lands with all that is left of her kin.', 'Send out riders, my lord. You must call for aid.','Gondor will answer.', 'Hurry! Inside. Get them inside!',' You said this fortress would never fall while your men defend it. They still defend it. They have died defending it.',
                        'Is there no other way for the women and children to get out of the caves? Is there no other way?','For Rohan. For your people.', 'One thing I have learned about Hobbits: They’re a most hardy folk.', 'Will you ride with us?', 'Six thousand will not be enough to break the lines of Mordor.', 'Every hour lost hastens Gondor’s defeat. We have till dawn, then we must ride.', 'It will not be our end, but his.', 'Not this time. This time you must stay, Gimli.', 'I do not fear death!', 'One who will have your allegiance.', 'You will suffer me.',
                        'I summon you to fulfill your oath.', 'I am Isildur’s heir. Fight for me, and I will hold your oaths fulfilled!', 'What say you?! You have my word! Fight, and I will release you from this living death! ...What say you?!', 'Legolas, fire a warning shot past the bosun’s ear.', ' I hold your oath fulfilled. Go. Be at peace.', 'Not for ourselves. But we can give Frodo his chance if we keep Sauron’s Eye fixed upon us. Keep him blind to all else that moves.', ' Long have you hunted me. Long have I eluded you. No more...Behold the Sword of Elendil!', ' I do not believe it. I will not.'] # I honestly don't know how many quotes there are here if you anyone wants to count feel free to do it and please let me know ]
